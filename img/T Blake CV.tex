...
\cventry{}{PostPilot}{Spartanburg, SC}{}{}{}
\cvline{April 2025-present}{As the sole Data Scientist at PostPilot, architects end-to-end consumer targeting and uplift modeling pipelines on Google Cloud Platform (BigQuery, Dataplex, Vertex AI, GCS). Implements advanced causal-inference frameworks including S‑, T‑, and DR‑Learners for incremental return on ad spend using record linkage to enable sophisticated feature engineering using BERT embeddings and residual connections to characterize consumers, brands and their interactions. Models propensity scores and importance weights to control for lack of randomization in treatment assignment and covariate drift, respectively. Scales modeling to hundreds of millions of consumers to enable highly granular, data-driven campaign optimization.}
\cvline{}{}
\subsection{Lead Consulting Data Scientist}
\cventry{}{g2o}{Columbus, OH}{}{}{}
\cvline{December 2024-March 2025}{Spearheaded the automation of invoice ingestion and digitization for Safelite Auto
Glass, streamlining claims management for insurance companies by processing invoices
from third-party automotive repair shops. Collaborated with cross-functional teams to align technical solutions with client goals and operational
requirements.  Designed and implemented an advanced OCR-based pipeline to process diverse invoice formats including PDFs, image files,
and handwritten documents received via fax or email. Using text extraction algorithms, identified and structured key data points, such as customer, vehicle, shop
information, services performed, replaced parts, and insurance policy details. Leveraged both AWS and Google Cloud services to create scalable, cloud-based solutions ensuring
high reliability and performance. Developed Python modules to power the end-to-end automation workflow, including OCR integration, data extraction, and model performance evaluation.}
\cvline{}{}
...
\cvline{}{}
\cvline{}{Served as technical lead for multiple Data Science's major initiatives including an effort to improve data quality by performing record linkage on a huge volume of bibliographic records, the backbone of almost the entirety of OCLC's product portfolio. By removing as many redundant records (records which refer to the same library asset) as possible, we were able to improve data quality and enhance product performance by leveraging both Natural Language Processing (NLP) techniques (word and paragraph embeddings) as well as supervised learning techniques to deliver a scalable classification model that identifies pairs of duplicate records.}
\cvline{}{}
\cvline{}{Oversaw the use of Large Language Models (LLMs) and Retrieval Augmented Generation (RAG) to  streamline the creation of XML stanzas for customer libraries employing an OCLC product that facilitates library patron authentication via SASL and TLS.}
\cvline{}{}
...
\cvline{September 2019-September 2020}{Lead consulting data scientist supporting federal government cyber defense efforts. Extracted structured and unstructured data from relational databases (MySQL and PostgreSQL) and MongoDB to train supervised machine learning models to identify phishing email campaigns. Leveraged model interpretation techniques implemented in Python to understand the best features for discriminating between phishing and non-phishing emails and how those inputs affect the probability of phishing attack.}
\cvline{}{}
...
\cvline{}{}
\subsection{Data Scientist}
\cventry{}{Starbucks Coffee Company}{Seattle, WA}{}{}{}
...
\cvline{August 2007 - June 2010}{Served as a lab instructor and lecturer for multiple undergraduate statistics courses, including STAT 1330, 1350, 1450: Introductory-level statistics courses designed for non-math majors and STAT 1428: senior-level statistics course tailored for engineering students.}
\cvline{}{}
\cvline{}{Delivered lectures and facilitated lab sessions guiding students through statistical concepts, problem-solving techniques, and real-world applications. Developed instructional materials, graded assignments and exams, and provided individualized support to enhance student comprehension and performance. Assisted in curriculum development and improvement by integrating data analysis software and modern statistical tools.}
