...
\cvline{}{R, Python (Jupyter, Sci-kit Learn, Pandas, Numpy, Matplotlib, Plotly), PySpark, SparkML, Tableau, Snowflake, Databricks, MLFlow}
\subsection{General Software Development:}
\cvline{}{Golang, Python, PySpark, SQL (Postgres, MySQL), Unix shell, Flask, Docker, Protocol Buffers (protobuf), basic knowledge of Java and HTML, AWS (EC2, RDS, Redshift, Elastic Beanstalk, S3, CLI)}
\subsection{Other:}
