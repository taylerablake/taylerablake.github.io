...
\cvline{}{Statistical/Analysis Software: R, SparkR, Python (Sci-kit learn, Pandas, Numpy, Matplotlib, Plotly), Tableau, basic knowledge of Apache Spark}
\cvline{}{Programming Languages: Golang, Python, SQL, Postgres, MySQL, Unix shell, Protocall Buffers (protobuf), basic knowledge of Java and HTML}
