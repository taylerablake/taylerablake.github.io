...
\cvline{}{R, Python (Jupyter, Sci-kit Learn, Pandas, Numpy, Matplotlib, Plotly), Tableau, Snowflake, Databricks, basic knowledge of Apache Spark}
\subsection{General Programming:}
\cvline{}{Golang, Python, SQL (Postgres, MySQL SQL Server), Unix shell, Flask, Docker, Protocoll Buffers (protobuf), basic knowledge of Java and HTML}
\subsection{Other:}
